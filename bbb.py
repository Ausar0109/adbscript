...
tIs = '2018-12-3'
tPLs = '2018-6-1'
tHs = somedays('2019-4-25', 90)
tpend = '2019-4-24'

sousuoci = '佳明手表,佳明235,佳明130,佳明运动手表,佳明935,佳明fenix3，佳明运动手表旗舰，garmin, garmin forerunner 935, garmin佳明fenix5, garmin男士, garmin佳明手表,apple watch 4, apple watch series 4, iwatch4, iwatch 4, applewatch4, apple watch series4,苹果手表4,苹果手表 4, 苹果手表apple watch 4,华为手表 watch gt, 华为手表watch gt智能运动手表,华为手表gt,华为watch2 pro,华为手表watch2,'  # '亚瑟男鞋,亚瑟女鞋,Asics,asics,ASICS,亚瑟士,亚瑟士跑鞋'
